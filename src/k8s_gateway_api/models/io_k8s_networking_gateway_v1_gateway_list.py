...
class IoK8sNetworkingGatewayV1GatewayList(BaseModel):
    """
    ...
    items: List[IoK8sNetworkingGatewayV1Gateway] = Field(description="List of gateways. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IoK8sNetworkingGatewayV1GatewayList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IoK8sNetworkingGatewayV1GatewayList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "items": [IoK8sNetworkingGatewayV1Gateway.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
