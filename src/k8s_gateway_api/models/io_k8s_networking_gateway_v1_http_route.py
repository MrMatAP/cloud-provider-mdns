...
class IoK8sNetworkingGatewayV1HTTPRoute(BaseModel):
    """
    ...
    spec: IoK8sNetworkingGatewayV1HTTPRouteSpec
    status: Optional[IoK8sNetworkingGatewayV1HTTPRouteStatus] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IoK8sNetworkingGatewayV1HTTPRoute from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IoK8sNetworkingGatewayV1HTTPRoute from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "spec": IoK8sNetworkingGatewayV1HTTPRouteSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": IoK8sNetworkingGatewayV1HTTPRouteStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
