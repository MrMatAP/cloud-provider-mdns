...
class IoK8sNetworkingGatewayV1HTTPRouteSpecRulesInnerBackendRefsInner(BaseModel):
    """
    ...
    """ # noqa: E501
    filters: Optional[Annotated[List[IoK8sNetworkingGatewayV1HTTPRouteSpecRulesInnerBackendRefsInnerFiltersInner], Field(max_length=16)]] = Field(default=None, description="Filters defined at this level should be executed if and only if the request is being forwarded to the backend defined here.  Support: Implementation-specific (For broader support of filters, use the Filters field in HTTPRouteRule.)")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IoK8sNetworkingGatewayV1HTTPRouteSpecRulesInnerBackendRefsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IoK8sNetworkingGatewayV1HTTPRouteSpecRulesInnerBackendRefsInner from a dict"""
        if obj is None:
            return None
