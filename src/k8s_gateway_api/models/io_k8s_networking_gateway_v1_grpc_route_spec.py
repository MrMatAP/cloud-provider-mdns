...
class IoK8sNetworkingGatewayV1GRPCRouteSpec(BaseModel):
    ...
    rules: Optional[Annotated[List[IoK8sNetworkingGatewayV1GRPCRouteSpecRulesInner], Field(max_length=16)]] = Field(default=None, description="Rules are a list of GRPC matchers, filters and actions.  ")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IoK8sNetworkingGatewayV1GRPCRouteSpec from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IoK8sNetworkingGatewayV1GRPCRouteSpec from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "rules": [IoK8sNetworkingGatewayV1GRPCRouteSpecRulesInner.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None
        })
        return _obj
